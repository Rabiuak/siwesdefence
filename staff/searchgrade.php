	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-success  ahover" style="font-size:115%; ">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item">
	            <a href="grade.php" class="nav-link">SIWESResult</a>
	          </li>
	          <li class="nav-item">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $regnum_to_search = $_POST["regnum_to_search"];

    // Replace with your actual SQL query to fetch data from the 'grade' table based on the registration number
    $sql = "SELECT * FROM grade WHERE regnum = '$regnum_to_search'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<h1>No Any Result of Students.</h1>" . $regnum_to_search;
    }
}
